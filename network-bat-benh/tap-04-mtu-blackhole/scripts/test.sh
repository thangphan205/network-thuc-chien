...
echo "ℹ️  Test này rớt 100% ở CẢ trước lẫn sau khi chữa — đường ống vẫn nghẽn, ta chỉ né nó."
...
echo "👉 Đọc kỹ: trước khi chữa curl vẫn báo 'HTTP 200' nhưng 'tải về 0 bytes' — header nhỏ về được, body to thì không."
