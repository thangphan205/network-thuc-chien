...
echo "🚀 Bắt đầu tạo 3 máy ảo Ubuntu 24.04 bằng Multipass và tự động cài K8s tools..."

# Tạo Control Plane
echo "[1/3] Đang khởi tạo Control Plane (2 CPUs, 2GB RAM)..."
multipass launch 24.04 --name controlplane --cpus 2 --memory 2G --disk 10G --cloud-init k8s-cloud-init.yaml

# Tạo Worker 1
echo "[2/3] Đang khởi tạo Worker 1 (1 CPU, 1.5GB RAM)..."
multipass launch 24.04 --name worker1 --cpus 1 --memory 1536M --disk 10G --cloud-init k8s-cloud-init.yaml

# Tạo Worker 2
echo "[3/3] Đang khởi tạo Worker 2 (1 CPU, 1.5GB RAM)..."
multipass launch 24.04 --name worker2 --cpus 1 --memory 1536M --disk 10G --cloud-init k8s-cloud-init.yaml
