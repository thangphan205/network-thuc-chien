# Lab Tập 43: Cilium LB IPAM + Egress Gateway — On-prem LoadBalancer & Fixed Egress IP
...
**Prerequisites:** Cilium cluster từ Tập 24. Không cần MetalLB hay cloud LB.
...
2. **L2 Announcement chỉ dùng được khi nodes cùng L2 segment:** Multipass/bare-metal đều OK. Cloud (VPC routing) cần BGP announcement thay vì L2 (xem Tập 46).
