...
Policy throughput (1000 policies):
  Flannel:  N/A
  Calico:   ~2 Gbps (iptables linear scan)
...
| **Managed K8s support** | All | All | EKS, GKE, AKS |
...
→ Flannel: Quick wins, no security
→ Calico: Balanced, battle-tested
→ Cilium: Maximum capability, higher complexity

2026 trend: Cilium adoption accelerating
  GKE, EKS, AKS: all support Cilium
  Service mesh (Istio, Linkerd) partially replaced by Cilium Mesh
  New projects: default to Cilium
```

> **Tập tiếp theo (Tập 45): Decision Framework — Khi nào dùng Flannel, Calico, Cilium trong Production?**
