...
**Prerequisites:** Cilium + Hubble UI running (từ Tập 25)
...
> **Tập tiếp theo (Tập 36):** Hubble Metrics — `hubble_drop_total`, `http_requests` và chọn đúng tool cho đúng tình huống.
