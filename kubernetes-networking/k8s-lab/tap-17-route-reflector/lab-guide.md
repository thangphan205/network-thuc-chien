# Lab Tập 17: Full Mesh vs Route Reflector
...
## 🛠 Yêu cầu chuẩn bị
- Cụm K8s với Calico từ Tập 16 đang chạy BGP mode.
- `calicoctl` đã cài.
...
## 🧹 Khôi phục full mesh (chuẩn bị cho Tập 18)

```bash
# Nếu muốn về full mesh cho Tập 18 (WireGuard):
calicoctl patch bgpconfiguration default \
