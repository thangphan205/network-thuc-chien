...
**Prerequisites:** Cilium đang chạy với sockops enabled (từ Tập 24)
...
> **Tập tiếp theo (Tập 29):** L3/L4 Policy trong Cilium — So sánh với Kubernetes NetworkPolicy và CiliumNetworkPolicy.
