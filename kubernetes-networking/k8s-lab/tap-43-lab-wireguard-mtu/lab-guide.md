# Lab Tập 43: Cilium Lab 4 — WireGuard MTU với Cilium, Hubble show "MTU exceeded"

Tập này reproduce và debug WireGuard MTU bug với Cilium: inject MTU sai (1500 thay vì 1420) trên cilium_wg0, file lớn hang, Hubble show "MTU exceeded" ngay — không cần `ping -M do` như Calico (Tập 24).
...
3. So sánh với Calico MTU debug (Tập 24):
   ```
