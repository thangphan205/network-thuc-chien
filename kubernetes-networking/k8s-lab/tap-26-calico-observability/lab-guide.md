# Lab Tập 26: Calico Observability — Prometheus + Grafana + AlertManager
...
5. **Limitation:** Calico observability cần tự setup stack. Cilium (Tập 27+) có Hubble built-in — flow visibility không cần setup thêm gì.
