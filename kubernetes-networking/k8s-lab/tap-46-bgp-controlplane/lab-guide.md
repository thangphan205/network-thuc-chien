# Lab Tập 46: Cilium BGP Control Plane — Advertise Pod CIDRs và LoadBalancer IPs
...
**Prerequisites:** Cilium cluster từ Tập 24. LB IPAM từ Tập 43 (tùy chọn nhưng nên có).
...
### 4.1 — Setup LB IPAM (nếu chưa có từ Tập 43)
...
1. **BGP = L3 solution cho L2-not-guaranteed environments:** L2 Announcement (Tập 43) chỉ work khi nodes cùng broadcast domain. BGP work bất kể topology — cross-VLAN, cross-datacenter, hybrid cloud.
