# Lab Tập 40: So sánh Flannel vs Calico vs Cilium — Benchmark thực tế

Tập này đo đạc thực tế trên Cilium cluster (từ Tập 23) và so sánh với con số từ Flannel/Calico đã học ở Phần 1–2. Mục tiêu: **số liệu, không phải lý thuyết**.

**Prerequisites:** Cilium cluster từ Tập 23 đang chạy (`cilium status` OK).
