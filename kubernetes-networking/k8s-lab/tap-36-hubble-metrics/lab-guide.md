# Lab Tập 36: Hubble Metrics — hubble_drop_total, http_requests và alerts
...
- kube-prometheus-stack đang chạy (từ Tập 24, namespace `monitoring`) — hoặc sẽ cài trong lab này.
