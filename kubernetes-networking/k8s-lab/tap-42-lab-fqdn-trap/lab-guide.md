# Lab Tập 42: Cilium Lab 3 — DNS Egress Policy & toFQDNs trap, External API fail bí ẩn
...
## 🔬 Thí nghiệm 1: Baseline — Internet access hoạt động
...
## 💥 Thí nghiệm 2: Apply policy Bug 1 — Quên allow DNS
...
## 🔬 Thí nghiệm 3: Fix Bug 1 — Add DNS allow rule
...
## 🔬 Thí nghiệm 4: Bug 2 — Stale FQDN cache và cách xử lý
