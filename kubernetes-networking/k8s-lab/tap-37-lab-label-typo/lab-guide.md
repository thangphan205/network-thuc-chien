# Lab Tập 37: Cilium Lab 1 — Pod label sai, Hubble show "Policy denied" ngay lập tức

Tập này thực hành debug scenario giống Tập 19 (Calico) nhưng với Cilium + Hubble: developer deploy backend-v2 quên label, frontend timeout, Hubble chỉ ra root cause trong 30 giây.
