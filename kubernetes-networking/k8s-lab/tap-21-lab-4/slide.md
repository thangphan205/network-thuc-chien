...
# Tập 21 - Lab Thực Chiến 4
## Network Policy Nâng Cao với Calico
...
```
Security audit yêu cầu (Hạ tầng On-Premise):
"Cluster đang chạy SaaS multi-tenant.
 ...
 Không Pod nào được reach dải IP quản trị / Metadata (169.254.169.254)
 — tránh nguy cơ dò quét và tấn công hạ tầng vật lý."
...
| Bất kỳ Pod nào | `169.254.169.254` (IP Quản trị/Metadata) | ❌ BLOCK |
