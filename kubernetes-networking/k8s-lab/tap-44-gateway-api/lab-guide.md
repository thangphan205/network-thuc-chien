# Lab Tập 44: Gateway API + Cilium Ingress — North-South Traffic
...
**Prerequisites:** Cilium cluster từ Tập 24, LB IPAM từ Tập 43 (cần EXTERNAL-IP).
...
# Chờ Gateway được assign IP từ LB IPAM pool (Tập 43)
