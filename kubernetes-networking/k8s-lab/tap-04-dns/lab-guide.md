...
## 🔬 Thực nghiệm 1: Vạch trần "Vấn đề ndots:5" bằng Tcpdump
...
## 🚀 Thực nghiệm 2: Tối ưu DNS bằng FQDN (Fully Qualified Domain Name)
...
## 🛡 Thực nghiệm 3: Tối ưu DNS bằng dnsConfig (Giảm ndots)
...
## 🔍 Thực nghiệm 4: Headless Service — DNS phân giải thẳng đến Pod IP
