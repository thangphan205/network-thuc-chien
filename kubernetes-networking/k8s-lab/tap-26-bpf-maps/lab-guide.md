# Lab Tập 26: BPF Maps — Inspect Hash, LRU, Array, Per-CPU trong Cilium
...
## 🛠 Yêu cầu chuẩn bị
- Cilium đang chạy trên cluster (từ Tập 25).
- `bpftool` có sẵn trong cilium-agent container.

---

## 🔬 Thí nghiệm 1: List tất cả BPF Maps Cilium tạo
...
## 🔬 Thí nghiệm 2: Xem Conntrack Table (LRU Hash Map)
...
## 🔬 Thí nghiệm 3: Xem Policy Map và Metrics
...
## 💥 Thí nghiệm 4: Demo O(1) BPF vs O(n) iptables
