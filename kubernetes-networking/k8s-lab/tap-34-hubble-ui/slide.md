...
**Prerequisites:** Cilium + Hubble UI running (từ Tập 24)
...
> **Tập tiếp theo (Tập 35):** Hubble Metrics — `hubble_drop_total`, `http_requests` và chọn đúng tool cho đúng tình huống.
